...
width = 0.5  # Gaussian width, 0.2 works for m400, 0.1 for m800, 0.05 for m1200
x_lim = [-5, 10]  # x axis limit eV
folder = '/Volumes/Storage/Data/Work/Postdoc/Work/testing/cp2k-smeagol/examples/SMEAGOL_TEST/Au_chain/dft-pdos-50atoms-q19'
...
labels_au = ['MO', 'Eigenvalue', 'Occupation', 's', 'py', 'pz', 'px', 'd-2', 'd-1', 'd0', 'd+1', 'd+2', 'f-3', 'f-2', 'f-1', 'f0', 'f+1', 'f+2', 'f+3']
...
pdos_au_a_f = sum_f(pdos_au, labels_au)
...
ax_cpdos_1.plot(energy_grid, smearing(eigenvalues, pdos_au_a_f.values, energy_grid, width), 'm', label='Au(f)')
