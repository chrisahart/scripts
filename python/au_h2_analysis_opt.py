...
for k in range(0, len(folder_cp2k_smeagol)):
    for i in range(len(data_cp2k_smeagol)):
        coord_dft, _, _, _, _, num_atoms, _ = load_coordinates.load_values_coord(folder_cp2k_smeagol[k], '{}/{}'.format(data_cp2k_smeagol[i], file_cp2k_smeagol), cols)
...
ax_plot_1.plot(data_cp2k_smeagol, bond_length_cp2k[0, :, atom_pair], 'o-', fillstyle='none', color=plotting_colors[k+1], label=labels[k+1])
...
ax_plot_3.plot(data_cp2k_smeagol, bond_length_cp2k[0, :, 2] - bond_length_cp2k[0, 0, 2], 'o-', fillstyle='none', color=plotting_colors[k+1], label=labels[k+1])
...
ax_plot_2.plot(data_cp2k_smeagol, collective_variable_cp2k[0, :], 'o-', fillstyle='none', color=plotting_colors[k+1], label=labels[k+1])
...
ax_cube_z[1].plot(data_cp2k_smeagol, bond_length_cp2k[0, :, atom_pair], 'o-', fillstyle='none', color=plotting_colors[k+1], label=labels[k+1])
...
ax_cube_z[0].plot(data_cp2k_smeagol, collective_variable_cp2k[0, :], 'o-', fillstyle='none', color=plotting_colors[k+1], label=labels[k+1])
