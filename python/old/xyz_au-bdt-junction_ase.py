...
folder = '/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/2023/au-bdt/benchmarking/structures/atoms-test'
folder_ref = folder
...
# surface_bulk = surface[[atom.index for atom in surface if atom.symbol == 'Au' and atom.position[2] < 8]]
# surface_l = surface[[atom.index for atom in surface if atom.symbol == 'Au' and atom.position[2] < 30]]
# surface_r = surface[[atom.index for atom in surface if atom.symbol == 'Au' and atom.position[2] < 28]]
...
for i in range(species_4.shape[0]):
    ...
    species_123[i] = 'Au_bulk'
    species_123[species_123.shape[0]-i-1] = 'Au_bulk'
