...
# CP2K /Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol
v_bias_cp2k = np.array([-2, -1.5, -1.0, -0.5, 0.0, 0.5, 1.0, 1.5, 2])
save_folder_cp2k = '/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point'

# without tip
# v_gs_without_tip_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/gs-notip/energy.out')
v_c1_without_tip_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/c1-notip/energy.out')
v_c2_without_tip_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/c2-notip/energy.out')
v_ts2_without_tip_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/ts2-guess-notip/energy.out')

# with tip 5A
v_gs_5A_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/gs/energy.out')
v_c1_5A_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/c1/energy.out')
v_c2_5A_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/c2/energy.out')
v_ts2_5A_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/ts2-guess/energy.out')

# with tip 3A
# v_gs_3A_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/gs-3A/energy.out')
v_c1_3A_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/c1-3A/energy.out')
v_c2_3A_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/c2-3A/energy.out')
v_ts2_3A_cp2k = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point/ts2-3A/energy.out')
...
# SIESTA /Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/cp2k-smeagol/iv-curve/single-point
# v_bias_siesta = np.array([-2, -1.5, -1.0, -0.5, 0.0, 0.5, 1.0, 1.5, 2])
v_bias_siesta = np.array([-1.0, -0.5, 0.0, 0.5, 1.0])
save_folder_siesta = '/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve'

v_gs_5A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve/gs_leads-sz-custom_surf-tip-dzp/energy.out')
v_c1_5A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve/c1_leads-sz-custom_surf-tip-dzp/energy.out')
v_c2_5A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve/c2_leads-sz-custom_surf-tip-dzp/energy.out')
v_ts1_5A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve/ts1_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')
v_ts2_5A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve/ts2_leads-sz-custom_surf-tip-dzp_from-cu2/energy.out')

v_gs_3A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve-3A/gs_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')
v_c1_3A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve-3A/c1_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')
v_c2_3A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve-3A/c2_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')
v_ts2_3A_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve-3A/ts2_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')

# v_gs_without_tip_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve-no-tip/gs_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')
# v_c1_without_tip_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve-no-tip/c1_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')
# v_c2_without_tip_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve-no-tip/c2_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')
# v_ts2_without_tip_siesta = np.loadtxt('/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/cp2k-smeagol-examples/examples/au-melamine/siesta1-smeagol/iv-curve-no-tip/ts2_leads-sz-custom_surf-tip-dzp_from-cu/energy.out')
