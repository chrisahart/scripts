...
folder = '/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/2023/au-wire-ismael/jad/structures/chris_9layers'
...
slab = fcc111('Au', size=(12, 12, 9), a=a)
...
bulk_left_a.positions[:, 2] =+ 2.42389*9

# Bulk right
bulk_right = atoms_within_cell.copy()
bulk_right.positions[:, 2] += 3.0226752151153697E+01 + 2.42389*9
...
jad_structure_cut.positions[:, 2] += 2.42389*9
