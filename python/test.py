...
file = '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/hfo2/archer/other/basis_function_vacuum/hf/basis-RESTART.wfn'
wfn = cp2k_wavefunction()
wfn.read_cp2k_wfn(file)
print(wfn)
print(wfn.vecs_all)