...
# folder = '/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Masters/2021-2022/Yike/Pt3Ni/chris_struct/supercell_2x2x2/archer2/optimise/alpha-beta/fm_Ni-2_temp-300_scf-1e-6'
folder = '/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Masters/2021-2022/Yike/Pt3Ni/chris_struct/supercell_2x2x2/archer2/optimise/magnetization-multiplicity/fm_scf-1e-6'
...
# Magnetisation
plot_log = False
x_label = 'Ni magnetization'
y_label = 'Pt magnetization'
x_units = 1/8
y_units = 1/24
...
# file_coord = file_coord.drop(file_coord[file_coord.SCF > 150].index)
