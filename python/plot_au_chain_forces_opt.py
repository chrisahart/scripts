...
folder_dft = '/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/2023/forces/au-chain/paper_ruoxing/opt_cp2k_MAX_FORCE-1.0E-04_CUTOFF-600/'
file_dft = 'au-chain_szv_shiftx_dftenergy-frc-1.xyz'
folder_V0 = '/Volumes/ELEMENTS/Storage/Postdoc/Data/Work/Postdoc/Work/calculations/transport/2023/forces/au-chain/paper_ruoxing/opt_cp2k-smeagol_chris_MAX_FORCE-1.0E-04_CUTOFF-600_scf-1e-7/'
file_V0 = 'au-chain_szv_shiftx_zerobias-frc-1.xyz'
...
ax_plot_atoms_all[2].plot(dft_time, (coord_dft[:, 0, atom+1]) * param.hartree_per_bohr_to_ev_per_angstrom, 'ko-', fillstyle='none', label='CP2K')
ax_plot_atoms_all[2].plot(V0_time, (coord_V0[:, 0, atom+1]) * param.hartree_per_bohr_to_ev_per_angstrom, 'ro-', fillstyle='none', label='CP2K-SMEAGOL')
