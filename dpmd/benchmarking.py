...
ax_benchmark_1.plot(archer_cores, archer_time_1_omp_2, 'o-', color=plotting_colors[1], label='ARCHER2 AMD 7742 OMP = 2', fillstyle='none')
...
ax_benchmark_1.plot(fugaku_omp_4_cores, fugaku_omp_4_time_1, 'o-', color=plotting_colors[5], label='Fugaku A64FX OMP = 4', fillstyle='none')
...
# ax_benchmark_2.plot(archer_cores_omp_2, archer_time_2_omp_2, 'o-', color=plotting_colors[0], label='ARCHER2 AMD 7742 OMP = 2', fillstyle='none')
...
# ax_benchmark_2.plot(fugaku_omp_12_cores, fugaku_omp_12_time_2, 'o-', color=plotting_colors[3], label='Fugaku A64FX OMP = 12', fillstyle='none')
