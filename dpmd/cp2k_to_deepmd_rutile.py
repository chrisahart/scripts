...
# tio2 336 rutile
# cp tio2-pos-1.xyz tio2-pos-1-backup.xyz
# vmd tio2-pos-1.xyz
# pbc set {13.8 13.8 17.76 90 90 90} -all ; pbc box    OLD
# pbc set {13.77 13.77 17.76 90 90 90} -all ; pbc box
# pbc wrap -all
# animate write xyz tio2-pos-1-vmd-wrap.xyz
# sed -i '' '/generated by VMD/ s/.*/ /'  tio2-pos-1-vmd-wrap.xyz
# ./clean.sh
...
# tio2 336 rutile PBE neutral OLD cell
folder = '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/md'
directory = '{}/neutral-4hours-100k-COMVEL_TO-1e-10-TEMPTOL-10-200k-300k'.format(folder)

# all 10 ps (database/pbe-3-ps)
size_exclude_start = int(0)
size_exclude_end = int(0)
size_test = int(500)
size_validation = int(500)

# the data contains 3105 frames
# the data contains 3105 frames after excluding the first and last frames
# the test data contains 500 frames
# the data contains 2605 frames after excluding the first and last frames and test set
# the training data contains 2105 frames
# the validation data contains 500 frames

# tio2 336 rutile PBE+U
# folder = '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/md-cell-opt'
# directory = '{}/electron-u-ti-3.0-300k-rs'.format(folder)

# all 10 ps (database/pbe-u-10-ps)
# size_exclude_start = int(0)
# size_exclude_end = int(0)
# size_test = int(2000)
# size_validation = int(2000)

# the data contains 10621 frames
# the data contains 10621 frames after excluding the first and last frames
# the test data contains 2000 frames
# the data contains 8621 frames after excluding the first and last frames and test set
# the training data contains 6621 frames
# the validation data contains 2000 frames

# 4 ps 6-10 ps (database/pbe-u-4-ps)
# size_exclude_start = int(6e3+(4621-4450))
# size_exclude_end = int(0)
# size_test = int(500)
# size_validation = int(500)

# the data contains 10621 frames
# the data contains 4450 frames after excluding the first and last frames
# the test data contains 500 frames
# the data contains 3950 frames after excluding the first and last frames and test set
# the training data contains 3450 frames
# the validation data contains 500 frames

# tio2 336 rutile HSE(25%)
# folder = '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/md-cell-opt'
# directory = '{}/electron-u-ti-3.0-300k-rs-hse-25-rs-3ps-nose'.format(folder)

# all 10 ps (database/hse-25-10-ps)
# size_exclude_start = int(0)
# size_exclude_end = int(0)
# size_test = int(2000)
# size_validation = int(2000)

# the data contains 10415 frames
# the data contains 10415 frames after excluding the first and last frames
# the test data contains 2000 frames
# the data contains 8415 frames after excluding the first and last frames and test set
# the training data contains 6415 frames
# the validation data contains 2000 frames

# 4 ps 6-10 ps (database/hse-25-4-ps)
# size_exclude_start = int(6e3-(50-15))
# size_exclude_end = int(0)
# size_test = int(500)
# size_validation = int(500)
...
# 3 ps 4-7 ps (database/hse-25-3-ps)
# size_exclude_start = int(4e3)
# size_exclude_end = int(3e3)
# size_test = int(500)
# size_validation = int(500)

# the data contains 10415 frames
# the data contains 3415 frames after excluding the first and last frames
# the test data contains 500 frames
# the data contains 2915 frames after excluding the first and last frames and test set
# the training data contains 2415 frames
# the validation data contains 500 frames

# tio2 336 rutile HSE(22%) 4 ps
# folder = '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/md-cell-opt/backup/4'
# directory = '{}/electron-u-ti-3.0-300k-rs-hse-25-rs-3ps-nose-rs-22-2'.format(folder)

# size_exclude_start = int(460)
# size_exclude_end = int(0)
# size_test = int(500)
# size_validation = int(500)

# the data contains 4910 frames
# the data contains 4450 frames after excluding the first and last frames
# the test data contains 500 frames
# the data contains 3950 frames after excluding the first and last frames and test set
# the training data contains 3450 frames
...
if charged: population_alpha = population_alpha[range(size_exclude_start, num_timesteps - size_exclude_end)]
if charged: population_beta = population_beta[range(size_exclude_start, num_timesteps - size_exclude_end)]
if charged: hirshfeld = hirshfeld[range(size_exclude_start, num_timesteps - size_exclude_end)]
