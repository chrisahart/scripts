...
if len(mobile) != len(reference):
    raise ValueError("Mismatch in number of Ti atoms between trajectory and reference")

# ─────────────────────────────────────────────
# TRANSFORMATIONS
# ─────────────────────────────────────────────
transformations = [
    trans.fit_rot_trans(mobile, reference),  # remove translation + rotation
    trans.wrap(u.atoms)                      # optional: keep atoms inside box
]
