...
set_ylim_linearity_hfx = [-0.3, 0.3]
set_ylim_band_gap_hubbard = [1.7, 3.2]
# set_ylim_band_gap_hubbard = [2, 3.4]
draw_gap = 3.03  # rutile
# draw_gap = 3.2   # anatase
...
# folder_files_hubbard = []
# for i in range(len(folder_use_hubbard)):
#     folder_files_hubbard.append(['/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/neutral/neutral-opt/{}'.format(folder_use_hubbard[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/electron/from-neutral/{}'.format(folder_use_hubbard[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/electron/from-md-1/{}'.format(folder_use_hubbard[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/neutral/from-electron//{}'.format(folder_use_hubbard[i])])
# hubbard_values_polaron = [[2.5, 2.6, 2.7, 2.8, 2.9, 3.0, 3.5, 4.0, 4.5, 5.0, 5.5, 6.0, 7.0, 8.0, 9.0]]
# colors_hse = ['k']
# labels_hse = ['']
# skip_folders_hse_start = 3
...
# #                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/electron/from-md-1/{}'.format(folder_use_hse[i]),
...
#     folder_files_hse.append(['/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/neutral/neutral-opt/{}'.format(folder_use_hse[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/electron/from-neutral/{}'.format(folder_use_hse[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/electron/from-pbe0-14/{}'.format(folder_use_hse[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/neutral/from-electron-pbe0-14//{}'.format(folder_use_hse[i])])
# hse_values_polaron = [[12, 15, 18, 20, 21, 22, 23, 24, 25, 30]]
# folder_use_pbe0 = ['pbe0-tz-tz2p-hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-mckenna-input']
# folder_use_pbe0 = []
# folder_files_pbe0 = []
...
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/electron/from-md-1/{}'.format(folder_use_pbe0[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/neutral/from-electron//{}'.format(folder_use_pbe0[i])])
# pbe0_values_polaron = [[10, 10.5, 11, 11.5, 12, 13, 14, 15, 25]]
# colors_pbe0 = ['g']
# labels_pbe0 = ['PBE0']
# skip_folders_pbe0_start = 0
...
# skip_folders_hse_end = -1
# skip_folders_hse_end_gap = -1
# folder_use_hse = ['hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-rs-tz-ti', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-rs-tz-ti-o', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-rs-tz-ti-tz2p-o']
# folder_use_hse = ['hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-rs-tz-ti-tz2p-o', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-tz-ti-tz2p-o']
# folder_use_hse = ['hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-rs-tz-ti-tz2p-o', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-tz-ti-tz2p-o']
# # folder_use_hse = ['hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-rs-tz-derived-ti-tz2p-o']  # FAILED
# folder_files_hse = []
# # for i in range(len(folder_use_hse)):
...
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-3310/geo-opt-cell-opt/electron/from-offset-107-hse-25/{}'.format(folder_use_hse[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-3310/geo-opt-cell-opt/neutral/from-offset-107-hse-25/{}'.format(folder_use_hse[i])])
# hse_values_polaron = [[12, 15, 18, 20, 21, 22, 23, 24, 25, 30]]
# folder_use_pbe0 = []
# folder_files_pbe0 = []
...
# labels_hse = ['3x3x4', '3x3x5', '3x3x6', '4x4x6']
# skip_folders_hse_start = 3
# skip_folders_hse_end = -1
# skip_folders_hse_end_gap = -1
# folder_use_hse = ['hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3']
...
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-336/geo-opt-cell-opt/neutral/from-electron-pbe0-14//{}'.format(folder_use_hse[i])])
# folder_use_hse = ['hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-rs-tz-ti-o']
# # folder_use_hse = ['hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3-rs-tz-ti-tz2p-o']
# for i in range(len(folder_use_hse)):
#     folder_files_hse.append(['/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-446/geo-opt-cell-opt/neutral/neutral-opt/{}'.format(folder_use_hse[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-446/geo-opt-cell-opt/electron/from-neutral/{}'.format(folder_use_hse[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-446/geo-opt-cell-opt/electron/from-pbe0-14/{}'.format(folder_use_hse[i]),
#                         '/Volumes/ELEMENTS/Storage/Postdoc2/Data/Work/calculations/tio2/rutile/archer/rutile/cell-446/geo-opt-cell-opt/neutral/from-electron-pbe0-14/{}'.format(folder_use_hse[i])])
# folder_use_hse = ['hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3', 'hfx-schwarz-e-1e-6-f-1e-6-fit9-pfit3']
# hse_values_polaron = [[12, 15, 18, 20, 21, 22, 23, 24, 25, 30], [12, 15, 18, 20, 21, 22, 23, 24, 25, 30], [12, 15, 18, 20, 21, 22, 23, 24, 25, 30], [12, 15, 18, 20, 21, 22, 23, 24, 25, 30]]
...
for i in range(len(folder_use_pbe0)):
    ...
    ax_linearity2.plot(pbe0_values_polaron[i][skip_folders_pbe0_start:skip_folders_pbe0_end],
                       non_linearity_alpha_pbe0_e[i][skip_folders_pbe0_start:skip_folders_pbe0_end] * param.hartree_to_ev, 'o-', fillstyle='none', color=colors_pbe0[i])
    ax_linearity2.plot(pbe0_values_polaron[i][skip_folders_pbe0_start:skip_folders_pbe0_end],
